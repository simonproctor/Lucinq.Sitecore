...
namespace Lucinq.SitecoreIntegration.IntegrationTests.Glass
{
	[TestFixture]
	public class GlassIntegrationTests
	{
	    ...
	    public void GetItemsUsingGlass()
	    {
            ...
            GlassSearchResult<PageContent> sitecoreSearchResult = new GlassSearchResult<PageContent>(service, search.Execute(queryBuilder));
            IItemResult<PageContent> result = sitecoreSearchResult.GetRange(0, 19);
