...
namespace Lucinq.SitecoreIntegration.Querying
{
    ...
    public class SitecoreQueryBuilder : QueryBuilder, ISitecoreQueryBuilder
    {
        ...
        {
            string fieldName = GetFieldName(FieldType.Id);
        ...
        public TermQuery TemplateId(ID templateId, Matches occur = Matches.NotSet, float? boost = null, string key = null)
        {
            ...
            string fieldName = GetFieldName(FieldType.TemplateId);
        ...
        {
            string luceneTemplateId = templateId.ToLuceneId();
            string fieldName = GetFieldName(FieldType.TemplatePath);
            return Term(fieldName, luceneTemplateId, occur, boost, key);
        }
        ...
        {
            string fieldName = GetFieldName(FieldType.Name);
        ...
        public Query Language(Language language, Matches occur = Matches.NotSet, float? boost = null, string key = null)
        {
            ...
            string fieldName = GetFieldName(FieldType.Language);
        ...
        public TermQuery DescendantOf(ID ancestorId, Matches occur = Matches.NotSet, float? boost = null, string key = null)
        {
            ...
            string fieldName = GetFieldName(FieldType.Paths);
        ...
        public TermQuery ChildOf(ID parentId, Matches occur = Matches.NotSet, float? boost = null, string key = null)
        {
            ...
            string fieldName = GetFieldName(FieldType.Parent);
        ...
        {
            string fieldName = GetFieldName(FieldType.Database);
        ...
        /// </summary>
        /// <returns></returns>
        public virtual string GetFieldName(FieldType fieldType)
        {
            switch (fieldType)
            {
                case FieldType.Id:
                    return SitecoreFields.Id;
                case FieldType.TemplateId:
                    return SitecoreFields.TemplateId;
                case FieldType.Database:
                    return SitecoreFields.Database;
                case FieldType.Parent:
                    return SitecoreFields.Parent;
                case FieldType.Paths:
                    return SitecoreFields.Path;
                case FieldType.TemplatePath:
                    return SitecoreFields.TemplatePath;
